        ...
        <>
          {availabilities.length === 0 ? (
            ...
            Object.entries(groupedAvailabilities).map(([typeId, group]) => {
              ...
              const typeTitle =
                group[0]?.transaction_title || `Type ID: ${typeId}`;
              return (
                        ...
                        <CardContent sx={{ pb: 1 }}>
                          ...
                          >
                            ...
                            <Box>
                              ...
                              <Typography variant="body2">
                                {availability.transaction_type_id}
                              </Typography>
                            </Box>
                          </Stack>
                                ...
                                {availability.time_windows.map((timeWindow) => {
                                  ...
                                  return (
                                    <TableRow key={timeWindow.time_window_id}>
                                      <TableCell>
                                        {formatDate(
                                          timeWindow.availability_date
                                        )}
                                      </TableCell>
                                      <TableCell>
                                        {timeWindow.start_time_am} -{" "}
                                        {timeWindow.end_time_am}
                                      </TableCell>
                                      <TableCell>
                                        {timeWindow.start_time_pm} -{" "}
                                        {timeWindow.end_time_pm}
                                      </TableCell>
